...
class HotelLegacyTravelScreen extends StatefulHookConsumerWidget {
  /// The constructor.
  const HotelLegacyTravelScreen({
  ...
  @override
  ConsumerState<HotelLegacyTravelScreen> createState() => _HotelLegacyTravelScreenState();
}

class _HotelLegacyTravelScreenState extends ConsumerState<HotelLegacyTravelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final hotels = ref.watch(travelsLegacyControllerProvider).hotelList;
    return Column(
      children: [
        Row(
                          ...
                          builder: (context, ref, child) {
                            return TAPrimaryButton(
                              ...
                              onTap: () async {
                                ...
                                final res = await ref.read(travelsLegacyControllerProvider.notifier).addHotel(hotel: hotel);
